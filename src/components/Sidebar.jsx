...
export default function Sidebar() {
  return (
    <aside className="w-60 min-h-screen bg-white border-r border-surface-200 flex flex-col flex-shrink-0">
      {/* Logo */}
      <div className="px-5 py-4 border-b border-surface-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-surface-900 leading-tight">LogiSense</h1>
            <p className="text-[10px] text-surface-400 font-medium">Smart Logistics</p>
          </div>
        </div>
      </div>
        ...
        {navItems.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              {item.sub && <span className="text-[10px] text-surface-400 -mt-0.5">{item.sub}</span>}
            </div>
          </NavLink>
        ))}
      </nav>
